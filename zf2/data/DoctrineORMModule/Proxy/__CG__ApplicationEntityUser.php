...
class User extends \Application\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'username', 'displayName', 'firstName', 'lastName', 'password', 'email', 'state', 'question', 'answer', 'picture', 'passwordSalt', 'registrationDate', 'registrationToken', 'emailConfirmed', 'language', 'role', 'user');
        }
